...
\hline
\multicolumn{2}{|c|}{\textbf{Cas d'utilisation : obtenir une réponse fondée sur les connaissances}} \\
\hline
...
3. Le système interroge la base de connaissances avec une requête dérivée de la question. \newline
...
\hline
\textbf{Alternative A : demande ambiguë} & À l'étape 2, si la demande ne peut être interprétée avec certitude, le système pose une question de clarification unique, puis reprend à l'étape 1. \\
\hline
\textbf{Alternative B : absence d'information} & À l'étape 4, si aucune connaissance pertinente n'est retrouvée, le système indique au client qu'il ne dispose pas d'une information suffisante pour répondre et lui propose une prise en charge alternative. Le cas se termine. \\
\hline
...
\hline
\end{tabular}
\caption{Description textuelle du cas Obtenir une réponse fondée sur les connaissances}
\label{tab:cu-doc}
\end{table}
...
\figureTikz{Diagramme de séquence système du cas Obtenir une réponse fondée sur les connaissances}{seq-doc}{fig-seq-doc}
