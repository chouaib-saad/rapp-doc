...
\begin{itemize}
  \item \textbf{Le client.} Abonné de l'opérateur, disposant d'un compte sur la plateforme. Il peut créer ce compte depuis le portail et vérifier son identité auprès des services de l'opérateur, ce qui lui permet ensuite d'agir avec l'agent. Il s'adresse à la plateforme pour obtenir une information ou faire réaliser une opération sur sa ligne, et accède par ailleurs à un portail où il retrouve sa situation, ses demandes et l'historique de ses échanges.
