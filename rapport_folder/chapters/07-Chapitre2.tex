...
La figure \ref{fig:seq-action} représente le scénario nominal de ce cas. Elle met en évidence la confirmation verbale, la vérification d'identité par\,\acro{CIN} et le caractère bloquant du verdict, qui conditionne toute transmission au système métier.
