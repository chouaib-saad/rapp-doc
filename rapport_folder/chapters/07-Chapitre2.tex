...
\subsection{Cas d'utilisation : gestion d'une demande d'assistance humaine}

\subsubsection{Diagramme du cas}

Ce cas, présenté à la figure \ref{fig:cu-escalade}, décrit le passage de la prise en charge automatique à la prise en charge humaine. Il peut être déclenché par une règle métier, par une demande explicite du client ou par la constatation d'un mécontentement persistant au fil de la conversation. La figure représente la gestion d'une demande d'assistance humaine : le système constitue le dossier, recherche un conseiller disponible, puis transfère l'appel ou planifie un rappel. Dans ce dernier cas, il crée un ticket de suivi auprès du système de gestion de tickets et notifie le client par le service de notification.

\figureTikz{Diagramme du cas d'utilisation Gestion d'une demande d'assistance humaine}{cu-escalade}{fig-cu-escalade}
...
\begin{tabular}{|p{3.0cm}|p{11.5cm}|}
\hline
\multicolumn{2}{|c|}{\textbf{Cas d'utilisation : gestion d'une demande d'assistance humaine}} \\
\hline
\textbf{Acteur principal} & Client \\
\hline
...
\hline
\end{tabular}
\caption{Description textuelle du cas Gestion d'une demande d'assistance humaine}
