...
Le diagramme de la figure \ref{fig:cu-general} présente une vue d'ensemble des cas d'utilisation de la plateforme et de leur répartition entre les acteurs. Le client y conduit l'échange ; l'utilisateur back-office supervise les interactions, administre la base de connaissances et traite les demandes escaladées. La facturation, la gestion de tickets et la notification apparaissent en acteurs secondaires.

\begin{figure}[p]
    \centering
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\textwidth, height=0.92\textheight, keepaspectratio]{figures/fig-cu-general.png}}
    \vspace{0.2cm}
    \caption{Diagramme de cas d'utilisation général de la plateforme}
    \label{fig:cu-general}
\end{figure}

Trois cas structurent le système et sont détaillés dans la suite : obtenir une information, effectuer une opération sécurisée et être mis en relation avec un conseiller humain.
...
Ce cas d'utilisation, présenté à la figure \ref{fig:cu-doc}, décrit une question du client sur les offres, les procédures ou les conditions de service. Le système recherche les passages pertinents dans la base de connaissances et répond à partir de ces sources, en tenant compte du contexte de l'échange.

\begin{figure}[htbp]
    \centering
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.82\textheight, keepaspectratio]{figures/fig-cu-doc..png}}
    \vspace{0.2cm}
    \caption{Diagramme du cas d'utilisation Recherche et génération d'une réponse fondée sur les connaissances}
    \label{fig:cu-doc}
\end{figure}
...
La figure \ref{fig:seq-doc} présente le scénario nominal d'une question documentaire. Le système charge le contexte, recherche puis évalue les passages pertinents et génère une réponse accompagnée de ses références. En cas de demande ambiguë, il demande une clarification ; s'il ne trouve aucun passage pertinent, il l'indique au client.

\begin{figure}[htbp]
    \centering
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.82\textheight, keepaspectratio]{figures/fig-seq-doc.png}}
    \vspace{0.2cm}
    \caption{Diagramme de séquence système du cas Recherche et génération d'une réponse fondée sur les connaissances}
    \label{fig:seq-doc}
\end{figure}
...
Ce cas, présenté à la figure \ref{fig:cu-action}, couvre toute opération produisant un effet sur le compte du client : règlement, report d'échéance, recharge, changement de forfait ou opération sur la ligne.

La figure \ref{fig:cu-action} présente la réalisation d'une opération sécurisée. Avant exécution, le système vérifie l'identité par\,\acro{CIN}, évalue la demande selon les règles métier, la transmet au système métier et l'enregistre dans le journal d'audit. Selon le résultat, l'opération est exécutée, refusée ou transmise à un conseiller.

\begin{figure}[htbp]
    \centering
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.82\textheight, keepaspectratio]{figures/fig-cu-action.png}}
    \vspace{0.2cm}
    \caption{Diagramme du cas d'utilisation Réalisation d'une opération sécurisée}
    \label{fig:cu-action}
\end{figure}
...
La figure \ref{fig:seq-action} présente le déroulement d'une opération sécurisée. Après confirmation du client et vérification de son identité, le système évalue la demande selon les règles métier. Selon le verdict, l'opération est exécutée par le système métier, refusée ou transmise à un conseiller ; une opération déjà traitée restitue son résultat sans être exécutée une seconde fois.

\begin{figure}[htbp]
    \centering
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-seq-action.png}}
    \vspace{0.2cm}
    \caption{Diagramme de séquence système du cas Réalisation d'une opération sécurisée}
    \label{fig:seq-action}
\end{figure}
...
Ce cas, présenté à la figure \ref{fig:cu-escalade}, décrit le passage de la prise en charge automatique à un conseiller humain. Le système constitue le dossier de l'échange, recherche un conseiller disponible puis transfère l'appel ou planifie un rappel. Dans les deux cas, le dossier est remis au conseiller.

\begin{figure}[htbp]
    \centering
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.82\textheight, keepaspectratio]{figures/fig-cu-escalade.png}}
    \vspace{0.2cm}
    \caption{Diagramme du cas d'utilisation Escalade vers un conseiller humain}
    \label{fig:cu-escalade}
\end{figure}
...
La figure \ref{fig:seq-escalade} présente l'escalade vers un conseiller. Le système constitue le dossier et recherche un conseiller disponible. Si un conseiller est disponible, l'appel lui est transféré ; sinon, un rappel est planifié et notifié.

\begin{figure}[htbp]
    \centering
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.82\textheight, keepaspectratio]{figures/fig-seq-escalade.png}}
    \vspace{0.2cm}
    \caption{Diagramme de séquence système du cas Escalade vers un conseiller humain}
    \label{fig:seq-escalade}
\end{figure}
