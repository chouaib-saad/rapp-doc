...
Quatre acteurs principaux ont été retenus. Les trois derniers correspondent à une hiérarchie de responsabilités croissantes, chaque niveau disposant des droits du niveau inférieur augmentés des siens.

\begin{itemize}
  \item \textbf{Le client.} Abonné de l'opérateur. Il s'adresse à la plateforme pour obtenir une information ou faire réaliser une opération sur sa ligne. Il interagit principalement par la voix, et accède par ailleurs à un portail où il retrouve sa situation, ses demandes et l'historique de ses échanges.
  \item \textbf{Le conseiller.} Agent du service client. Il prend en charge les conversations qui lui sont transmises par la plateforme et traite les demandes de rappel qui lui sont attribuées. Il dispose du niveau de droits le plus bas parmi les profils internes.
  \item \textbf{Le superviseur.} Responsable de la supervision opérationnelle. Il observe l'activité de la plateforme, consulte les conversations et les décisions prises, suit les indicateurs et organise la disponibilité des conseillers.
  \item \textbf{L'administrateur.} Responsable de la configuration et de la gouvernance du système. Il gère les comptes, les règles métier, les référentiels et la base documentaire, et dispose des moyens de contrôle de l'intégrité des enregistrements.
\end{itemize}
...
\hline
Client & Principal & Exprimer une demande et obtenir sa résolution & Conversation vocale ou textuelle, portail client \\
\hline
Conseiller & Principal & Traiter les conversations transmises et les rappels attribués & Console de supervision, reprise d'appel \\
\hline
Superviseur & Principal & Observer l'activité, suivre les indicateurs, organiser les disponibilités & Console de supervision \\
\hline
Administrateur & Principal & Configurer les règles, les référentiels et la base documentaire, contrôler l'intégrité & Console d'administration \\
\hline
...
La plateforme doit pouvoir consulter les tickets existants d'un client, en créer de nouveaux, les mettre à jour et les clôturer lorsque le problème est résolu. Elle doit connaître l'historique des tickets du client afin d'éviter la création de doublons et de tenir compte des difficultés déjà signalées.
...
Le client doit disposer d'un espace personnel lui permettant de consulter son profil, sa situation de facturation, ses demandes, ses rappels programmés et l'historique de ses conversations. Il doit également pouvoir consulter et effacer les informations que la plateforme conserve de ses échanges antérieurs, et n'accéder en aucun cas aux données d'un autre client.

\subsection{Supervision et administration}

Les profils internes doivent disposer des moyens d'observer et de gouverner le système. Cela recouvre la consultation des conversations et de leurs transcriptions, l'inspection des décisions et des verdicts rendus, le suivi des indicateurs d'activité, la gestion des conseillers et de leurs disponibilités, l'administration des règles métier et des référentiels, la gestion de la base documentaire et le contrôle de l'intégrité du registre des opérations.

\subsection{Récapitulatif}

La figure \ref{fig:carte-besoins} récapitule ces besoins sous forme de carte, un bloc par domaine. Cette vue d'ensemble sert de repère pour la suite du rapport : la conception du chapitre suivant s'organise autour des mêmes domaines.

\figureTikz{Carte des besoins fonctionnels par domaine}{carte-besoins}{fig-carte-besoins}
...
Le diagramme de la figure \ref{fig:cu-general} présente une vue d'ensemble des cas d'utilisation de la plateforme et de leur répartition entre les acteurs. Le client y accède aux cas relevant de la conversation et de son espace personnel. Les profils internes accèdent aux cas de supervision et d'administration, selon la hiérarchie de droits établie plus haut. Les systèmes tiers apparaissent en acteurs secondaires des cas qui les sollicitent.

\figureTikz{Diagramme de cas d'utilisation général de la plateforme}{cu-general}{fig-cu-general}

Trois cas d'utilisation structurent l'ensemble du système et méritent un traitement détaillé. Le premier couvre le trajet complet d'une question documentaire, de la parole du client jusqu'à la réponse ancrée dans la documentation. Le deuxième couvre l'exécution d'une opération engageant le compte du client, qui concentre l'essentiel des garanties de sûreté de la plateforme. Le troisième couvre le passage à un conseiller humain, qui constitue la frontière entre l'autonomie du système et l'intervention humaine. Chacun fait l'objet d'un diagramme, d'une description textuelle et d'un diagramme de séquence système décrivant son scénario nominal.

\subsection{Cas d'utilisation : obtenir une réponse documentaire}

\subsubsection{Diagramme du cas}

Ce cas d'utilisation, présenté à la figure \ref{fig:cu-doc}, décrit la situation la plus fréquente : le client pose une question portant sur les offres, les procédures ou les conditions de service, et attend une réponse exacte.

\figureTikz{Diagramme du cas d'utilisation Obtenir une réponse documentaire}{cu-doc}{fig-cu-doc}
...
\hline
\multicolumn{2}{|c|}{\textbf{Cas d'utilisation : obtenir une réponse documentaire}} \\
\hline
\textbf{Acteur principal} & Client \\
\hline
\textbf{Acteurs secondaires} & Aucun \\
\hline
\textbf{Objectif} & Obtenir une réponse exacte à une question portant sur les offres, les procédures ou les conditions de service. \\
\hline
\textbf{Préconditions} & Une conversation est établie entre le client et la plateforme. La base documentaire est disponible et indexée. \\
\hline
\textbf{Postconditions} & Le client a reçu soit une réponse ancrée dans la documentation, soit l'indication explicite que l'information n'est pas disponible. L'échange est enregistré. \\
\hline
\textbf{Scénario nominal} &
1. Le client formule sa question à l'oral. \newline
2. Le système transcrit la parole et identifie l'intention documentaire. \newline
3. Le système interroge la base documentaire avec une requête dérivée de la question. \newline
4. Le système reçoit les passages pertinents accompagnés de leur source. \newline
5. Le système formule une réponse brève, fondée uniquement sur ces passages. \newline
6. Le système énonce la réponse et propose au client d'en obtenir le détail. \newline
7. L'échange est consigné dans le journal de conversation. \\
\hline
\textbf{Alternative A : demande ambiguë} & À l'étape 2, si l'intention ne peut être déterminée avec certitude, le système pose une question de clarification unique, puis reprend à l'étape 1. \\
\hline
\textbf{Alternative B : absence de réponse} & À l'étape 4, si aucun passage ne satisfait les critères de pertinence, le système indique au client qu'il ne dispose pas de cette information et lui propose une prise en charge alternative. Le cas se termine. \\
\hline
...
\hline
\end{tabular}
\caption{Description textuelle du cas Obtenir une réponse documentaire}
\label{tab:cu-doc}
\end{table}

\subsubsection{Diagramme de séquence système}

La figure \ref{fig:seq-doc} représente le scénario nominal sous forme d'échanges entre le client et le système, considéré ici comme une boîte noire.

\figureTikz{Diagramme de séquence système du cas Obtenir une réponse documentaire}{seq-doc}{fig-seq-doc}

\subsection{Cas d'utilisation : exécuter une opération sensible}
...
\figureTikz{Diagramme du cas d'utilisation Exécuter une opération sensible}{cu-action}{fig-cu-action}
...
\begin{tabular}{|p{3.0cm}|p{11.5cm}|}
\hline
\multicolumn{2}{|c|}{\textbf{Cas d'utilisation : exécuter une opération sensible}} \\
\hline
\textbf{Acteur principal} & Client \\
\hline
\textbf{Acteurs secondaires} & Systèmes métier de l'opérateur \\
\hline
\textbf{Objectif} & Faire exécuter une opération produisant un effet sur le compte du client, avec la garantie qu'elle est autorisée, exécutée une seule fois et consignée. \\
\hline
\textbf{Préconditions} & Une conversation est établie. Le client est rattaché à un compte. L'opération demandée figure parmi les opérations reconnues par le système. \\
\hline
\textbf{Postconditions} & L'opération a été exécutée et confirmée, ou refusée avec un motif, ou transmise à un conseiller. Dans tous les cas, un verdict motivé et une trace vérifiable ont été enregistrés. \\
\hline
\textbf{Scénario nominal} &
...
4. Le système vérifie l'identité du client si cette vérification n'est pas déjà valide. \newline
5. Le système constitue le contexte de la décision à partir de la situation vérifiée du client. \newline
6. Le système soumet l'opération aux règles métier, qui rendent un verdict motivé. \newline
...
8. Le système consigne l'opération et son verdict dans le registre. \newline
9. Le système confirme le résultat au client à l'oral. \\
\hline
\textbf{Alternative A : identité non confirmée} & À l'étape 4, si la vérification échoue après le nombre d'essais autorisé, l'opération est abandonnée, le client en est informé, et le refus est consigné. \\
\hline
\textbf{Alternative B : opération refusée} & À l'étape 6, si le verdict est défavorable, le système énonce au client le motif du refus dans des termes compréhensibles. L'opération n'est pas transmise. Le verdict est consigné. \\
\hline
\textbf{Alternative C : transmission à un conseiller} & À l'étape 6, si le verdict impose une intervention humaine, le système engage le cas d'utilisation d'escalade en transmettant le contexte constitué. \\
\hline
\textbf{Alternative D : reprise} & Si la même opération est présentée une seconde fois pour la même conversation, le système restitue le résultat de la première exécution sans exécuter à nouveau. \\
\hline
\end{tabular}
\caption{Description textuelle du cas Exécuter une opération sensible}
\label{tab:cu-action}
\end{table}

\subsubsection{Diagramme de séquence système}

La figure \ref{fig:seq-action} représente le scénario nominal de ce cas. Elle met en évidence la confirmation verbale, la vérification d'identité et le caractère bloquant du verdict, qui conditionne toute transmission au système métier.

\figureTikz{Diagramme de séquence système du cas Exécuter une opération sensible}{seq-action}{fig-seq-action}

\subsection{Cas d'utilisation : escalader vers un conseiller humain}
...
\figureTikz{Diagramme du cas d'utilisation Escalader vers un conseiller humain}{cu-escalade}{fig-cu-escalade}
...
\begin{tabular}{|p{3.0cm}|p{11.5cm}|}
\hline
\multicolumn{2}{|c|}{\textbf{Cas d'utilisation : escalader vers un conseiller humain}} \\
\hline
\textbf{Acteur principal} & Client \\
\hline
\textbf{Acteurs secondaires} & Conseiller, service de notification \\
\hline
\textbf{Objectif} & Confier la demande à un conseiller humain, immédiatement si possible, à une échéance convenue sinon, sans perte du contexte déjà constitué. \\
\hline
\textbf{Préconditions} & Une conversation est établie. Une condition d'escalade est satisfaite. \\
\hline
\textbf{Postconditions} & La conversation a été transférée à un conseiller, ou un rappel a été réservé sur un créneau réel et le conseiller concerné en a été avisé. Le dossier de l'échange est disponible dans les deux cas. \\
\hline
\textbf{Scénario nominal} &
...
\hline
\textbf{Alternative A : aucun conseiller disponible} & À l'étape 3, si aucun conseiller n'est disponible, le système en informe le client et lui propose un rappel. Il présente des créneaux issus des disponibilités réelles, convient d'un créneau avec le client, le réserve, puis confirme l'horaire retenu. Le conseiller concerné est avisé avec le dossier. \\
\hline
...
\hline
\textbf{Alternative C : refus du rappel} & Si le client décline la proposition de rappel, le système clôt l'échange en récapitulant ce qui a été fait et en indiquant les moyens de contact disponibles. \\
\hline
\end{tabular}
\caption{Description textuelle du cas Escalader vers un conseiller humain}
\label{tab:cu-escalade}
\end{table}

\subsubsection{Diagramme de séquence système}

La figure \ref{fig:seq-escalade} représente le scénario nominal et son alternative principale, la planification d'un rappel.

\figureTikz{Diagramme de séquence système du cas Escalader vers un conseiller humain}{seq-escalade}{fig-seq-escalade}

\section*{Conclusion}

Ce chapitre a transformé les objectifs du projet en spécifications exploitables. Nous avons identifié quatre acteurs principaux, organisés selon une hiérarchie de droits, et trois familles d'acteurs secondaires correspondant aux systèmes que la plateforme sollicite sans les posséder. Nous avons ensuite formulé trente quatre besoins fonctionnels répartis en huit domaines, puis douze besoins non fonctionnels dont chacun impose une propriété identifiée à l'architecture. Les cas d'utilisation ont enfin été présentés dans leur ensemble, et détaillés pour les trois qui structurent le système : la réponse documentaire, l'opération sensible et l'escalade vers un conseiller.

Ces trois cas font apparaître une même exigence sous des formes différentes. La réponse documentaire impose que le système sache reconnaître les limites de ce qu'il sait. L'opération sensible impose qu'il sache reconnaître les limites de ce qu'il a le droit de faire. L'escalade impose qu'il sache reconnaître les limites de ce qu'il peut traiter seul. Le chapitre suivant montre comment l'architecture de la solution répond à ces trois exigences, en présentant d'abord la vue statique du système, puis sa vue dynamique, avant de détailler la conception de la couche agentique et celle du contrôle d'accès.
