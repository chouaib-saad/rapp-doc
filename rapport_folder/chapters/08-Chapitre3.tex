...
\begin{figure}[!htb]
  ...
  \fbox{%
    \adjustbox{max width=\linewidth-18pt,
               max totalheight=0.82\textheight}{%
      \includegraphics{figures/fig-archi-hexagonale.png}%
    }%
  }
  \caption{Architecture hexagonale de la plateforme}
  \label{fig:archi-hexagonale}
\end{figure}
...
\hline
Inférence & Proposer une action candidate assortie d'un degré de confiance. \\
\hline
Décision & Rendre un verdict motivé sur une action, et contrôler une réponse sortante. \\
\hline
...
\begin{itemize}
  ...
  \item \textbf{Décision.} La proposition d'action, les règles métier et les verdicts rendus.
...
\begin{figure}[!htb]
  ...
  \fbox{%
    \adjustbox{max width=\linewidth-18pt,
               max totalheight=0.82\textheight}{%
      \includegraphics{figures/fig-paquetages.png}%
    }%
  }
  \caption{Diagramme de paquetages des contextes métier}
...
\begin{figure}[!htb]
  ...
  \fbox{%
    \adjustbox{max width=\linewidth-18pt,
               max totalheight=0.82\textheight}{%
      \includegraphics{figures/fig-composants.png}%
    }%
  }
...
\begin{figure}[htbp]
    ...
    \vspace{0.2cm}
    \caption{Diagramme de classes du moteur de décision}
    \label{fig:classes-decision}
\end{figure}
...
Le moteur de décision évalue ensuite l'action et persiste son verdict. Selon le résultat, l'opération est exécutée, refusée ou transmise à un conseiller ; chaque issue est inscrite dans le journal d'audit.
...
\begin{figure}[H]
    ...
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-act-ingestion.png}}
    \vspace{0.2cm}
    \caption{Diagramme d'activités de l'ingestion documentaire}
    \label{fig:act-ingestion}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-act-recherche.png}}
    \vspace{0.2cm}
    \caption{Diagramme d'activités de la recherche documentaire}
    \label{fig:act-recherche}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-etats-conversation.png}}
    \vspace{0.2cm}
    \caption{Diagramme d'états transitions d'une conversation}
    \label{fig:etats-conversation}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-etats-ticket.png}}
    \vspace{0.2cm}
    \caption{Diagramme d'états transitions d'un ticket}
    \label{fig:etats-ticket}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-pipeline-agent.png}}
    \vspace{0.2cm}
    \caption{Pipeline de raisonnement d'un agent}
    \label{fig:pipeline-agent}
\end{figure}
...
\begin{figure}[H]
    ...
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-orchestration.png}}
    \vspace{0.2cm}
    \caption{Orchestration des agents et transitions}
...
\begin{figure}[H]
    ...
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-contexte.png}}
    \vspace{0.2cm}
    \caption{Assemblage du contexte d'un agent}
    \label{fig:contexte}
\end{figure}
...
Le premier moment précède l'action. Toute opération sensible est soumise au moteur de décision décrit plus haut, qui rend un verdict à quatre valeurs accompagné de la règle décisive, du niveau de confiance et d'une justification. Ce contrôle n'est pas contournable, puisque le chemin qui mène à l'exécution passe par lui.
...
\begin{figure}[H]
    ...
    \setlength{\fboxsep}{0pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=\linewidth, height=0.88\textheight, keepaspectratio]{figures/fig-securite.png}}
    \vspace{0.2cm}
    \caption{Modèle de sécurité de la plateforme}
    \label{fig:securite}
\end{figure}
