...
- [ ] Figure 11/36: `fig-classes-agents.svg` — AWAITING user-supplied complete SVG (user instructed not to confirm the draft; user will provide the final SVG). Draft taxonomy chosen: accueil + 3 métiers + supervision.
- [ ] Figures 12/36 → 36/36: pending per-figure analysis → proposal → generation → validation.
